extension Descriptor {
  public static let gattCharacteristicExtendedProperties = Descriptor(
  ...
  public static let gattCharacteristicUserDescription = Descriptor(
    ...
    source: "gss")
  public static let gattClientCharacteristicConfiguration = Descriptor(
    name: "Client Characteristic Configuration",
    identifier: "org.bluetooth.descriptor.gatt.client_characteristic_configuration",
    uuidString: "2902", source: "gss")
  public static let gattServerCharacteristicConfiguration = Descriptor(
  ...
  public static let gattCharacteristicPresentationFormat = Descriptor(
  ...
  public static let gattCharacteristicAggregateFormat = Descriptor(
...
extension Descriptor: All {
  public static let all: [Descriptor] = [
    .gattCharacteristicExtendedProperties, .gattCharacteristicUserDescription,
    .gattClientCharacteristicConfiguration, .gattServerCharacteristicConfiguration,
    .gattCharacteristicPresentationFormat, .gattCharacteristicAggregateFormat, .validRange,
    .externalReportReference, .reportReference, .numberOfDigitals, .valueTriggerSetting,
    .environmentalSensingConfiguration, .environmentalSensingMeasurement,
    .environmentalSensingTriggerSetting, .timeTriggerSetting, .completeBredrTransportBlockData,
  ]
}
